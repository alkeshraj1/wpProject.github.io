...
<html lang="en">
	...
	<?php } ?>
	<a href="../Teacher/teacher-index.php" style="display:flex;align-items:center;justify-content:center"> <button type="button" class="btn btn-secondary bg-success" data-dismiss="modal">BACK</button> </a>
