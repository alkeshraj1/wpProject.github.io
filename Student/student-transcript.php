...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            ...
            <h4 class="text-dark mt-3">LERNIFY*</h4>
            <h4 class="text-dark">UNIVERSITY OF COMPUTER SCIENCE DESIGNED BY - ALKESH RAJ</h4>
        </div>
    </div>
    <div class="container-fluid mb-4 text-dark">
        ...
        <div class="d-flex mt-3">
            ...
            <div class="ml-auto">
                ...
                <h5>Year of Addmission : <?php echo intval($row['admission_date']) . " ". $row['session']; ?></h5>
            </div>
        </div>
        <?php }
        ?>
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <tr>
                                    <th colspan="4">Semester GPA</th>
                                    <?php $all_semester_quality_points = $all_semester_quality_points + $total_quality_points; ?>
                                    <th colspan="2"><?php echo  round($total_quality_points/2, 2); ?></th>
                                </tr>
                            </table>
                        </div>
                    </section>
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <tr>
                                    <th colspan="4">Semester GPA</th>
                                    <?php $all_semester_quality_points = $all_semester_quality_points + $total_quality_points; ?>
                                    <th colspan="2"><?php echo  round($total_quality_points/233, 2); ?></th>
                                </tr>
                            </table>
                        </div>
                    </section>
                    <div class="col-md-4  mt-3">
								<a href="student-index.php" > <button type="button" class="btn btn-secondary bg-success" data-dismiss="modal">BACK</button> </a>
								</div>
                </div>
            </div>
        </div>
